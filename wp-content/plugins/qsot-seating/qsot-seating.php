...
class QSOT_seating_launcher {
	...
	protected static $me = '';
	// plugin version
	protected static $version = '2.2.11-qa';
	...
	public static function pre_init() {
		...
		if ( self::_pass_system_requirements() ) {
			// load the seating cacher first
			require_once self::$plugin_dir . 'seating/cacher.php';
	...
	public static function activation() {
		...
		// make sure we have some needed stuff initialized, in core woo
		if ( ! isset( $wc->product_factory ) )
			WC()->init();
		...
		require_once $path . 'seating-zoner.class.php';
		require_once $path . 'seating-area-type.class.php';
